...
corrs(s4, 'gut_only_gut')

## Results for gut:
#                    Transmissibility  SpearmanR   p-value    N
#      SGB_household_transmissibility  -0.170880  0.092507   98
#   SGB_intradataset_transmissibility  -0.063930  0.499199  114
#  SGB_mother-infant_transmissibility  -0.441523  0.002396   45
...
corrs(s5, 'oral_only_mouth')

## Results for oral:
#                                Transmissibility  SpearmanR   p-value   N
#   SGB_mother-offspring_transmissibility_until1y  -0.535340  0.000151  45
#   SGB_mother-offspring_transmissibility_until3y  -0.384097  0.000564  77
#  SGB_mother-offspring_transmissibility_until18y  -0.353199  0.000595  91
#                  SGB_household_transmissibility  -0.332952  0.001261  91
#               SGB_intradataset_transmissibility   0.141249  0.181709  91
