def conversion_from_GTDB_to_pGenomes():
    ...
    # from GTDB
    data = pd.read_table('data/bac120_metadata_r202.tsv.xz',
                         sep='\t',
                         header='infer',
                         low_memory=False)
    ...
    data2 = pd.read_table('data/ar122_metadata_r202.tsv.xz',
                         sep='\t',
                         header='infer',
                         low_memory=False)
    ...
    refdata = pd.read_table('data/progenomes_samples.tsv.xz',
                            sep='\t',
                            header=None, 
    ...
    print('... export 1')
    dfd.to_csv('data/gtdb_to_pgenomes.tsv.xz',
               sep='\t',
               header=True,
               index=None)
    ...
    print('... export 2')
    df.to_csv('data/conv_pgen_to_gtdb_list.tsv.xz',
              sep='\t',
              header='infer',
              index=None)
