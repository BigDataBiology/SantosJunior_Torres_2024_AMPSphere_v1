def taxon_affiliation():
    ...
    print('# filter AMPs not associated to any origin')
    ...
    print('''# classify AMPs according lowest known levels   
    ...
    print('# convert dataframe of AMPs with annotated origins')
    ...
    print('## finding AMPs annotated to more than 1 genus:')
    ...
    print('## finding 25 most common genera:')
    ...
    print('## finding 10 most common genera:')
